 ...
 */
public class AdapterItemExecutar extends RecyclerView.Adapter<AdapterItemExecutar.SimpleViewHolder> {

    private Context context;
    private List<Servicos> itens;
    private ClickListener clickListner;

    public AdapterItemExecutar(Context context, List<Servicos> itens, ClickListener clickListner){
        this.itens = itens;
